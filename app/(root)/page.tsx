              ...
              >
                ...
                <div className="flex w-full flex-col xl:flex-row xl:justify-between !important">
                  <div className="flex flex-col gap-1">
                    <p className="text-[19px] leading-[20px] font-semibold line-clamp-1 w-full text-light-100 sm:max-w-[200px] lg:max-w-[250px] !important">{file.name}</p>
                    <FormattedDateTime
                      date={file.$createdAt}
                      className="text-[17px] leading-[16px] font-normal"
                    />
                  </div>
